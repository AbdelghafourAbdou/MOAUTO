...
if (isset($_POST['num'])) {
    ...
    $$Insertt = " Insert into line( invoiceid, cartid, productid, linequantity, linehistoricalprice, linepaymenttype) values (:invoiceid, :cartid, :productid, :linequantity, :linehistoricalprice, :linepaymenttype)"; 
